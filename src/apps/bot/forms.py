...
COVERAGE_ERROR_MESSAGE = (
    ...
    "Если фонд охватывает всю страну, то нужно указывать ТОЛЬКО страну. "  # как может фонд охватывать всю страну ???
    "Если фонд охватывает весь регион, то нужно указывать ТОЛЬКО регион."  # то же и про регион, в каких городах региона детдома? куда придется ездить?
)
